...
$templateData = array(
	...
	'TEMPLATE_LIBRARY' => array('popup', 'currency'),
...
?>
	<div class="item_buttons vam">
		<span class="item_buttons_counter_block" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" style="display: <? echo ($canBuy == 'Y' ? '' : 'none'); ?>;">
<?
	if ($showBuyBtn)
	{
?>
...
?>
		...
		<span id="<? echo $arItemIDs['NOT_AVAILABLE_MESS']; ?>" class="bx_notavailable" style="display: <? echo ($canBuy == 'N' ? '' : 'none'); ?>;"><? echo $notAvailableMessage; ?></span>
	</div>
<?
}
