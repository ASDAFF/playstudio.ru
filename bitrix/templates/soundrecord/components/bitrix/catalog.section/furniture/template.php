...
?>
	<div class="catalog-item-title"><a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["NAME"]?></a><?if(!empty($arElement["DISPLAY_PROPERTIES"]["NOVELTY"]["DISPLAY_VALUE"])):?><span class="novelty"><?=$arElement["DISPLAY_PROPERTIES"]["NOVELTY"]["NAME"]?></span><?endif;?></div>
<?
...
?>
					<div class="catalog-item-price"><span><?=$arResult["PRICES"][$code]["TITLE"];?>:</span> <?=$arPrice["PRINT_VALUE"]?>  <?=GetMessage("CATALOG_CURRENCY")?></div>
<?
		endif;
	endforeach;
?>
