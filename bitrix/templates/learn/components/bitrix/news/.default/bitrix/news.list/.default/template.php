...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="news-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
				<div class="news-title"><a class="news-detail-link" href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?echo $arItem["NAME"]?></a></div>
		...
		<?endforeach;?>
		<style>.news-detail-link2{display:none;}</style>
	<a class="news-detail-link2" href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?=GetMessage('MEWS_DETAIL_LINK')?> &rarr;</a>
	</div>
<?endforeach;?>
